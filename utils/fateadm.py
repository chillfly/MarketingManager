...
# 用户中心页可以查询到pd信息
pd_id = "111534"
pd_key = "Eld+qDrV2M/N1Tp4BIyV0qSvsrhSyTzw"
# 开发者分成用的账号，在开发者中心可以查询到
app_id = "311534"
app_key = "3mxXwlUu0iGUDzwriqJ99Zg37sj/y0Fm"
# 识别类型，30500：五个英文数字组合
pred_type = "30500"
...
def get_captcha_code(file_name, pred_type="30500"):
    """
    从图片中获取验证码
    :param file_name:
    :param pred_type:
    ...
    code = api.PredictFromFileExtend(pred_type, file_name)
    return code
